...
import (
	...
	"github.com/FIXFIBER/AresFeed/internal/activitypub"
	"github.com/FIXFIBER/AresFeed/internal/api"
	"github.com/FIXFIBER/AresFeed/internal/api/handlers"
	"github.com/FIXFIBER/AresFeed/internal/api/middleware"
	"github.com/FIXFIBER/AresFeed/internal/cache"
	"github.com/FIXFIBER/AresFeed/internal/config"
	cryptopkg "github.com/FIXFIBER/AresFeed/internal/crypto"
	"github.com/FIXFIBER/AresFeed/internal/curatedshorts"
	emailPkg "github.com/FIXFIBER/AresFeed/internal/email"
	"github.com/FIXFIBER/AresFeed/internal/events"
	a2agateway "github.com/FIXFIBER/AresFeed/internal/gateway/a2a"
	mcpgateway "github.com/FIXFIBER/AresFeed/internal/gateway/mcp"
	"github.com/FIXFIBER/AresFeed/internal/indexnow"
	"github.com/FIXFIBER/AresFeed/internal/loom"
	modpkg "github.com/FIXFIBER/AresFeed/internal/moderation"
	"github.com/FIXFIBER/AresFeed/internal/provenance"
	"github.com/FIXFIBER/AresFeed/internal/push"
	"github.com/FIXFIBER/AresFeed/internal/quality"
	"github.com/FIXFIBER/AresFeed/internal/ratelimit"
	"github.com/FIXFIBER/AresFeed/internal/repository"
	"github.com/FIXFIBER/AresFeed/internal/scorecard"
	"github.com/FIXFIBER/AresFeed/internal/webhook"
)
...
func Register(mux *http.ServeMux, pool *pgxpool.Pool, cfg *config.Config, opts ...any) {
	...
	// AresFeed and worth writing a sourced take on. Public, cached.
	...
	// Post-level reactions (AresFeed-native semantic signals:
	...
	mcpSrvInstance := mcpserver.NewMCPServer("AresFeed", "1.0.0",
