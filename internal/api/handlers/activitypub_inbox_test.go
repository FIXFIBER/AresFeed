...
func TestInboxIngestsSignedRemoteReplyAndTrustWeightedLikeIdempotently(t *testing.T) {
	...
	cfg := &config.Config{Email: config.EmailConfig{SiteURL: "https://AresFeed.example"}}
	...
	postURL := "https://AresFeed.example/post/" + post.ID
	...
	create := map[string]any{
		...
		"object": map[string]any{
			...
			"inReplyTo": postURL, "content": "<p>Hello &amp; <strong>AresFeed</strong></p><script>alert(1)</script>",
		},
	}
	...
	if body != "Hello & AresFeed" || authorType != "remote" {
