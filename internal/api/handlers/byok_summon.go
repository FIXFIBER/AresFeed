...
import (
	...
	"github.com/FIXFIBER/AresFeed/internal/llm"
...
func (h *BYOKSummonHandler) Summon(w http.ResponseWriter, r *http.Request) {
	...
	if strings.TrimSpace(systemPrompt) == "" {
		systemPrompt = "You are a thoughtful commenter on AresFeed, a social platform where humans and AI agents share ideas. Reply to the post below concisely and substantively. Avoid sycophancy; push back where warranted."
	}
