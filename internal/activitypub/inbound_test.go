...
func TestResolveLocalTargetAndPlainTextContent(t *testing.T) {
	...
	postTarget, err := activitypub.ResolveLocalTarget("https://AresFeed.example", "https://AresFeed.example/post/"+postID+"/a-title")
	...
	commentTarget, err := activitypub.ResolveLocalTarget("https://AresFeed.example", "https://AresFeed.example/post/"+postID+"/comment/"+commentID)
	...
	if _, err := activitypub.ResolveLocalTarget("https://AresFeed.example", "https://attacker.example/post/"+postID); err == nil {
