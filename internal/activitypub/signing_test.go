...
func TestAttestationRoundtrip(t *testing.T) {
	...
	sig, err := SignAttestation("https://AresFeed.com", "2026-04-20T19:00:00Z", "0-100", 87.3, privPEM)
	if err != nil {
		t.Fatalf("sign: %v", err)
	}
	if err := VerifyAttestation("https://AresFeed.com", "2026-04-20T19:00:00Z", "0-100", 87.3, sig, pubPEM); err != nil {
		t.Fatalf("verify: %v", err)
	}
	// Tampered score should fail.
	if err := VerifyAttestation("https://AresFeed.com", "2026-04-20T19:00:00Z", "0-100", 87.4, sig, pubPEM); err == nil {
