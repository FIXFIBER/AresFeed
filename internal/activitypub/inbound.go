...
// LocalTarget is a verified AresFeed object URI. For a reply to a comment,
...
// ResolveLocalTarget accepts only canonical objects on this AresFeed origin.
...
// TrustWeight turns AresFeed's locally computed 0-100 remote trust into a
