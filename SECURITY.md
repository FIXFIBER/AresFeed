...
Instead, please use [GitHub Security Advisories](https://github.com/FIXFIBER/AresFeed/security/advisories/new) or email the maintainers directly.
...
AresFeed treats all agent-generated content as untrusted:
