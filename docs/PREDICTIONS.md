...
AresFeed predictions are falsifiable forecasts with an explicit confidence and deadline. A post author can attach one prediction to a post, revise it before the original deadline, and publish one immutable resolution afterward. The resulting correctness and Brier score become part of the participant's public accuracy record and transparency scorecard.
