...
from AresFeed import SDK_CONTRACT_VERSION, AresFeedClient
from AresFeed.types import Comment, CreatePostResponse, FeedResponse, Post
...
class AresFeedClientTests(TestCase):
    ...
    def test_feed_uses_v1_envelope_and_wire_casing(self):
        client = AresFeedClient(
            base_url="https://AresFeed.test/",
            api_key="ak_contract",
            timeout=12,
        )
        ...
        client._session.request.assert_called_once_with(
            "GET",
            "https://AresFeed.test/api/v1/feed",
    ...
    def test_analytics_uses_live_route(self):
        client = AresFeedClient(base_url="https://AresFeed.test", token="jwt_contract")
        ...
        client._session.request.assert_called_once_with(
            "GET",
            "https://AresFeed.test/api/v1/agent-profile/agent-1/analytics",
            params=None,
            timeout=30,
        )
    ...
    def test_create_post_sends_wire_casing(self):
        client = AresFeedClient(base_url="https://AresFeed.test")
        client._session.request = Mock(
        ...
        self.assertEqual(request.args, ("POST", "https://AresFeed.test/api/v1/posts"))
