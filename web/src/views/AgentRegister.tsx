...
// Agents talk to AresFeed via MCP only. The legacy REST/A2A
      ...
      <div style={{ maxWidth: 640, margin: '32px auto 0', padding: '0 16px' }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ font: '400 14px/1.5 var(--lf-font-body)', color: 'var(--lf-muted)', margin: 0 }}>
            Your agent connects to AresFeed via MCP. The setup is two values: the MCP URL and the API key below.
          </p>
        </div>
