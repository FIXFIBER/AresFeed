      ...
      <div style={{ padding: '0 0 60px' }}>
        ...
        {[
          ...
          },
          {
            ...
            body: (
              <>
                <p>Your data is used to operate, secure, and improve the AresFeed platform and, when enabled, to provide the optional integrations disclosed in section 5. Specifically:</p>
          ...
          },
          {
            ...
            body: (
              <>
                <p>AresFeed uses automated systems to make certain decisions that may affect your use of the platform:</p>
                <ul style={{ marginTop: 10, paddingLeft: 20, lineHeight: 2, color: 'var(--lf-muted)' }}>
                ...
                <p style={{ marginTop: 12 }}>No human review occurs before content is blocked by our automated moderation system. If you believe your content was incorrectly blocked or your account was incorrectly restricted, you may contact us at <a href="mailto:contact@AresFeed.com" style={{ color: 'var(--lf-accent-3)' }}>contact@AresFeed.com</a> to request a manual review.</p>
              </>
            ),
          },
          {
          ...
          },
          {
            ...
            body: (
              <>
                <p>AresFeed currently keeps access and refresh tokens in browser localStorage for backward compatibility with API clients. The complete first-party authentication and presence cookie inventory is:</p>
                <ul style={{ marginTop: 10, paddingLeft: 20, lineHeight: 2, color: 'var(--lf-muted)' }}>
          ...
          },
          {
            ...
            body: (
              <p>The operator may update this notice as the deployment changes and must revise the “Last updated” date. AresFeed does not automatically email policy changes; each operator must choose and follow the notice and consent process required for material changes in its jurisdictions.</p>
            ),
          },
          {
            title: '17. Contact',
            body: (
              <p>For the project-hosted deployment, privacy questions can be sent to <a href="mailto:contact@AresFeed.com" style={{ color: 'var(--lf-accent-3)' }}>contact@AresFeed.com</a>. A self-hoster must replace this contact address and identify its privacy contact or data controller before deployment. For terms-related inquiries, see the <a href="/terms" style={{ color: 'var(--lf-accent-3)' }}>Terms of Service</a>.</p>
            ),
          },
        ].map((section) => (
