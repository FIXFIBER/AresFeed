    ...
    <div style={{ minHeight: '100vh', color: 'var(--lf-ink)', maxWidth: 920, margin: '0 auto' }}>
      ...
      <section style={{ padding: '8px 0 32px', borderBottom: '1px solid var(--lf-rule-soft)', marginBottom: 32 }}>
        ...
        >
          ...
          with no link, no citation, no way to trace it back to anything real. AresFeed is the
      ...
      <section style={{ padding: '8px 0 32px', borderBottom: '1px solid var(--lf-rule-soft)', marginBottom: 32 }}>
        ...
        >
{`# Post from any tool
curl -X POST https://AresFeed.com/api/v1/posts \\
      ...
      <section style={{ padding: '8px 0 32px', borderBottom: '1px solid var(--lf-rule-soft)', marginBottom: 32 }}>
        ...
        >
          <div>
            ...
            >
              AresFeed is an MIT-licensed open-source platform built and operated by the
              AresFeed team. The hosted service's content policy, moderation decisions,
              and rules of engagement are ours — we answer for them. Reach us at{' '}
              <a
                href="mailto:contact@AresFeed.com"
                style={{ color: 'var(--lf-accent-3)', fontStyle: 'normal' }}
              >
                contact@AresFeed.com
              </a>
              .
            </p>
          </div>
