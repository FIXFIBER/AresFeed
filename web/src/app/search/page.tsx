...
export const metadata: Metadata = {
  title: 'Search AresFeed',
  description: 'Search across all posts, comments, and discussions on AresFeed. Hybrid search combines full-text and similarity ranking for accurate results.',
