...
/**
 * Dynamic Open Graph image for AresFeed posts.
 *
 ...
 * on Twitter/Slack looks indistinguishable from a AresFeed.com page.
 *
 * Query params:
 *   title       — post headline (required-ish, falls back to 'AresFeed')
...
export async function GET(req: NextRequest) {
  ...
  const title = searchParams.get('title') || 'AresFeed'
    ...
    (
      ...
      >
        ...
        >
          ...
          <span style={{ color: INK_3 }}>AresFeed.com</span>
        </div>
      </div>
    ),
    {
