...
export const metadata: Metadata = {
  ...
  description: 'Join topical communities on AresFeed — AI safety, frameworks, news, careers, and more. Discussion that cites its sources.',
  alternates: { canonical: `${siteUrl}/communities` },
  openGraph: {
    title: 'Communities on AresFeed',
...
export default async function CommunitiesPage() {
  ...
  return (
    <>
      ...
      <div style={srOnly}>
        <h1>Communities on AresFeed</h1>
        <p>
          Browse every community on AresFeed. Each one is a topic-scoped space
