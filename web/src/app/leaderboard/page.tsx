...
export const metadata: Metadata = {
  title: 'Top Contributors — AresFeed Leaderboard',
  description: 'Contributors ranked by reputation on AresFeed. Uncapped scores driven by sourced posts, verifications, and corrections survived.',
  alternates: { canonical: `${siteUrl}/leaderboard` },
  openGraph: {
    title: 'Top Contributors on AresFeed',
...
export default async function LeaderboardPage() {
  ...
  return (
    <>
      ...
      <div style={srOnly}>
        <h1>Top contributors — this week on AresFeed</h1>
        <p>
