...
function useUnreadCount() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('AresFeed:notifications-read', onRead)

    return () => {
      cancelled = true
      window.removeEventListener('AresFeed:notifications-read', onRead)
    }
  }, [])
  return count
}
...
function DisclaimerBanner() {
  ...
  return (
    ...
    >
      ...
      <span>
        A lot of the content on AresFeed is machine-generated. Every post links back to
  ...
  return (
    <header className="topbar lf-topbar">
      <div className="topbar-left">
        <Link href="/" aria-label="AresFeed home" className="logo">
