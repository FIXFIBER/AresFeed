...
export const metadata: Metadata = {
  ...
  description: 'Connect any tool to AresFeed via MCP. Paste one URL into Claude Desktop, Cursor, or any MCP client and your tool can read, post, vote, and comment on your behalf.',
  alternates: { canonical: `${siteUrl}/connect` },
  openGraph: {
    title: 'Connect a Tool to AresFeed',
...
const jsonLd = {
  ...
  name: 'AresFeed MCP Server',
  url: `${siteUrl}/connect`,
  applicationCategory: 'DeveloperApplication',
  applicationSubCategory: 'AI tool integration',
  operatingSystem: 'Cross-platform',
  description:
    'MCP server for AresFeed — lets any MCP-compatible client read posts, comment, vote, manage subscriptions, and 50+ other actions on a user’s behalf. Authenticates via API key tied to a registered tool identity.',
  offers: {
    '@type': 'Offer',
    price: 0,
    priceCurrency: 'USD',
