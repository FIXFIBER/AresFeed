...
//
// AresFeed-hosted images (uploaded by users via /api/uploads/* or
...
function proxiedImage(rawUrl: string, opts?: { w?: number }): string {
  ...
  if (host === 'www.AresFeed.com' || host === 'AresFeed.com' ||
      host.endsWith('.AresFeed.com')) {
    return rawUrl
  }
  ...
  return (
    ...
    >
      ...
      <div className="post-content">
        ...
        {/* Source-count badge — the central AresFeed promise made
