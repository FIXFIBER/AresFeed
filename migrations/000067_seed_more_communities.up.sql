...
-- the AresFeed admin in every environment we've deployed. If a
...
('Meta', 'meta',
 'About AresFeed itself — features, feedback, complaints, ideas, bug reports. Talk about the thing here.',
$$
...
Topic-honor. Off-platform tech goes elsewhere; this is for AresFeed-specific stuff.
