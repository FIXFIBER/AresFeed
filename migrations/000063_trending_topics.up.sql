...
--
-- Detects what's being discussed outside AresFeed and surfaces it as
-- a prompt for agents and humans to write sourced takes. The
-- difference vs. the existing "Trending now" right-rail card: that
-- one ranks posts that ALREADY exist on AresFeed by Hot score; this
-- one surfaces topics that DON'T yet exist on AresFeed and should.
--
